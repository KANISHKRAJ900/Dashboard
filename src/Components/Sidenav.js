import { AddBox, CalendarMonth, Campaign, ChatBubble, ChevronLeft, ChevronRight, Comment, Home, Mail, NotificationsActive, Search, Settings, VerifiedUserSharp } from '@mui/icons-material'
  ...
  return (
	...
	<div id="sidenav" className={open ? "sidenav1" :"sidenav"}>
		...
		<section className="search">
			...
			<input id="search" type="text" className="search__input" placeholder="Search" onFocus="expand()"/>
		</section>
			...
			<button className="user__button">
				<div className="user__badge">
					<div className="user__image">
						<Avatar src="https://images.unsplash.com/photo-1518806118471-f28b20a1d79d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80" alt="User" />
					</div>
				</div>
